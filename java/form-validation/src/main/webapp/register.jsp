...
<html>
    <head>
        ...
        <script type="text/javascript" src="static/js/fancybox.js?v=2.1.5"></script>
    ...
    <body style="background:#f0f0f0 url(static/image/bg.png); display:flex; font-family:Microsoft Yahei;">
        <div class="bg"></div>
        ...
        <div class="box shadow">
            ...
            <span class="subhead">
                <a href="#messages" class="fancybox">DIV弹窗</a> |
                <a href="registerH5.jsp" class="fancybox fancybox.iframe" title="弹出JSP">页面弹窗</a> |
                <a href="static/image/carousel1.jpg" class="fancybox">图片弹窗</a>
            </span>

            <h2 class="mainTitle">表单验证: JS + AJAX + CSS3 + Popup + Responsive Design</h2>

            <form action="register" method="post" onSubmit="return validation('Submit')" autocomplete="off">
                <div class="line">
                    <label for="name" class="labelText">账 号</label>
                    <input class="inputText" type="text" id="name" name="name" placeholder="只能含有字母、数字、汉字及下划线"/>
                    <label for="name" class="tips status1">请输入用户名</label><br>
                </div>
                ...
                <div class="line">
                    <label for="phone" class="labelText">手机号</label>
                    <input class="inputText" type="text" id="phone" name="phone"/>
                    <label for="phone" class="tips status1">请输入手机号码</label><br>
                </div>
