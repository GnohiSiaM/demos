...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="static/css/tuckedCorners.css"/>
        <link rel="stylesheet" type="text/css" href="static/css/gear.css"/>
        <style type="text/css">
            .body_bg {
                background: #ECECEC url(static/image/bg.png);
            ...
            <div class="tucked-corners-bottom">
                <div class="gears">
                    <div class="gear gear-t">
                        <img src="static/image/gear.png" alt="">
                    </div>
