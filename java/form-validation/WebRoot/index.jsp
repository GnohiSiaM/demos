...
<html>
        ...
        <style type="text/css">
            * {
            ...
            .mybox {
                ...
                padding: 20px;
                border-radius: 9px;
                -webkit-box-shadow: inset 0px 0px 9px rgba(32, 32, 32, 0.9);
                -moz-box-shadow: inset 0px 0px 9px rgba(32, 32, 32, 0.9);
                -o-box-shadow: inset 0px 0px 9px rgba(32, 32, 32, 0.9);
                -ms-box-shadow: inset 0px 0px 9px rgba(32, 32, 32, 0.9);
                box-shadow: inset 0px 0px 9px rgba(32, 32, 32, 0.9);
            }
            p {
                ...
                -webkit-transition: border-bottom 1s,-webkit-box-shadow 1s;
                -moz-transition: border-bottom 1s,-moz-box-shadow 1s;
                -o-transition: border-bottom 1s,-o-box-shadow 1s;
                transition: border-bottom 1s,box-shadow 1s;
            }
            p:hover {
                border-radius: 3px;
                border-bottom: 1px solid transparent;
                background: #f0f0f0 url(image/bg.png);
    ...
    <body style="background:#f0f0f0 url(image/bg.png); font-family:Microsoft Yahei;">
        ...
        <aside id="sidebar" class="sidebar">
            <header>
                <a href="index.jsp" rel="home">
                    <img class="logo" src="image/inter.jpg" alt="logo">
                </a>
                <span class="slogan">请对我残酷些<br>-= <strong style="color:black;">${userName}</strong> =-<br>他朝我走得坚壮些</span>
            </header>
            <section>
                <ul class="quick_nav">
        ...
        <div class="mybox">
            ...
            <br/><strong>Answer : </strong>由满6向空5倒，剩1升，把这1升倒5里，然后6剩满，倒5里面，由于5里面有1升水，因此6只能向5倒4升水，然后将6剩余的2升，倒入空的5里面，再灌满6向5里倒3升，剩余3升。
            </p>
            <p>
            ...
            <br/><strong>Answer : </strong>设杯子编号为ABCDEF，ABC为满，DEF为空，把B中的水倒进E中即可。
            </p>
            <p>
            ...
            <br/><strong>Answer : </strong>小林在轮到自己且小黄没死的条件下必杀黄，再跟菜鸟李单挑。
            ...
            <br/><strong>Answer : </strong>是让甲分汤，分好后由乙和丙按任意顺序给自己挑汤，剩余一碗留给甲。这样乙和丙两人的总和肯定是他们两人可拿到的最大。然后将他们两人的汤混合之后再按两人的方法再次分汤。
            </p>
            <p>
            【5】在一张长方形的桌面上放了n个一样大小的圆形硬币。这些硬币中可能有一些不完全在桌面内，也可能有一些彼此重叠；当再多放一个硬币而它的圆心在桌面内时，新放的硬币便必定与原先某些硬币重叠。请证明整个桌面可以用4n个硬币完全覆盖。
            <br/><strong>Answer : </strong>要想让新放的硬币不与原先的硬币重叠，两个硬币的圆心距必须大于直径。也就是说，对于桌面上任意一点，到最近的圆心的距离都小于2，所以，整个桌面可以用n个半径为2的硬币覆盖。
            ...
            <br/><strong>Answer : </strong>底下放一个1，然后2 3放在1上面，另外的4 5竖起来放在1的上面。
            </p>
            <p>
            ...
            <br/><strong>Answer : </strong>15%*80%/(85％×20％＋15%*80%)
            </p>
            <p>
            ...
            <br/><strong>Answer : </strong>f(x)=(60-2x)*x,当x=15时，有最大值450。
            450×4
            </p>
            <p>
            ...
            <br/><strong>Answer : </strong>因为1=5，所以5=1．
            </p>
            <p>
            ...
            <br/><strong>Answer : </strong>本题可用递归算法，但时间复杂度为2的n次方，也可以用动态规划法，时间复杂度为n的平方，实现起来相对要简单得多，但最方便的就是直接运用公式：排队的种数=(2n)!/[n!(n+1)!]。
            ...
            <br/><strong>Answer : </strong>2元
            </p>
            <p>
            【16】有一种体育竞赛共含M个项目，有运动员A，B，C参加，在每一项目中，第一,第二,第三名分别的X，Y，Z分，其中X,Y,Z为正整数且X>Y>Z。最后A得22分，B与C均得9分，B在百米赛中取得第一。求M的值，并问在跳高中谁得第二名。
            <br/><strong>Answer : </strong>因为ABC三人得分共40分,三名得分都为正整数且不等,所以前三名得分最少为6分,40=5*8=4*10=2*20=1*20,不难得出项目数只能是5.即M=5.
            ...
            <p>
            【17】前提：
            <br/><strong>Answer : </strong>1 有五栋五种颜色的房子
            2 每一位房子的主人国籍都不同
            ...
            <br/><strong>Answer : </strong>1． 红房子在蓝房子的右边，白房子的左边（不一定紧邻）
            ...
            <p>
            【19】斗地主附残局
            <br/><strong>Answer : </strong>地主手中牌2、K、Q、J、10、9、8、8、6、6、5、5、3、3、3、3、7、7、7、7
            ...
            <br/><strong>Answer : </strong>先拿下第一楼的钻石，然后在每一楼把手中的钻石与那一楼的钻石相比较，如果那一楼的钻石比手中的钻石大的话那就把手中的钻石换成那一层的钻石。
            </p>
            <p>
            ...
            <br/><strong>Answer : </strong>2＋1先过 2
            然后1回来送手电筒 1
            5＋10再过 10
            2回来送手电筒 2
            2＋1过去 2
            ...
            <br/><strong>Answer : </strong>样本空间为（男男）（女女）（男女）（女男）
            ...
            <p>
            【23】为什么下水道的盖子是圆的？
            <br/><strong>Answer : </strong>不会掉下去
            </p>
            <p>
            【24】有7克、2克砝码各一个，天平一只，如何只用这些物品三次将140克的盐分成50、90克各一份？
            <br/><strong>Answer : </strong>140->70＋70 70->35＋35
            35＋70＝105
            105->50＋7 ＋ 55＋2
            55＋35＝90
            </p>
            ...
            <br/><strong>Answer : </strong>把第一块芯片与其它逐一对比，看看其它芯片对第一块芯片给出的是好是坏，如果给出是好的过半，那么说明这是好芯片，完毕。如果给出的是坏的过半，说明第一块芯片是坏的，那么就要在那些在给出第一块芯片是坏的芯片中，重复上述步骤，直到找到好的芯片为止。
            </p>
            <p>
            【26】12个球一个天平，现知道只有一个和其它的重量不同，问怎样称才能用三次就找到那个球。13个呢？（注意此题并未说明那个球的重量是轻是重）
            <br/><strong>Answer : </strong>12个时可以找出那个是重还是轻，13个时只能找出是哪个球，轻重不知。
            　　把球编为①②③④⑤⑥⑦⑧⑨⑩⑾⑿。（13个时编号为⒀）
            　　第一次称：先把①②③④与⑤⑥⑦⑧放天平两边，
            　　　　㈠如相等，说明特别球在剩下4个球中。
            　　　　　　把①⑨与⑩⑾作第二次称量，
            ...
            <br/><strong>Answer : </strong>首先求解原题。每道题的答错人数为（次序不重要）：26，21，19，15，9
            ...
            <br/><strong>Answer : </strong>十年可能包含2-3个闰年，3652或3653天。
            ...
            <br/><strong>Answer : </strong>下行是对上一行的解释 所以新的应该是3个1 2个2 1个1 ：312211
            </p>
            <p>
            【30】烧一根不均匀的绳要用一个小时，如何用它来判断半个小时？烧一根不均匀的绳,从头烧到尾总共需要1个小时。现在有若干条材质相同的绳子,问如何用烧绳的方法来计时一个小时十五分钟呢? （微软的笔试题）
            <br/><strong>Answer : </strong>一，一根绳子从两头烧，烧完就是半个小时。
            ...
            <br/><strong>Answer : </strong>注：当然是有代价的，称过的药我们就不用了
            ...
            <br/><strong>Answer : </strong>取出标着15便士的盒中的一个硬币，如果是银的说明这个盒是20便士的，如果是镍的说明这个盒是10便士的，再由每个盒的标签都是错误的可以推出其它两个盒里的东西。
            </p>
            <p>
            【33】有一个大西瓜,用水果刀平整地切,总共切9刀,最多能切成多少份,最少能切成多少份?主要是过程，结果并不是最重要的
            <br/><strong>Answer : </strong>最少10，最多130
            见下表，表中蓝色部分服从2为底的指数函数规律，红色部分的数值均为其左边与左上角的两个数之和。
            x0123456789
            x个点最多能把直线分成多少部分12345678910
            x条直线最多能把平面分成多少部分1247111622293746
            x个平面最多能把空间分成多少部分12481526426493130
            </p>
            <p>
            【34】一个巨大的圆形水池，周围布满了老鼠洞。猫追老鼠到水池边，老鼠未来得及进洞就掉入水池里。猫继续沿水池边缘企图捉住老鼠（猫不入水）。已知V猫=4V鼠。问老鼠是否有办法摆脱猫的追逐？
            <br/><strong>Answer : </strong>第一步：游到水池中心。
            ...
            <br/><strong>Answer : </strong>表示为880，接下来，将一个大桶的水倒入小桶中，倒满，表示为853，（第2个大桶减3，小桶加3）则过程如下：
            ...
            <br/><strong>Answer : </strong>砝码将以与猴子相同的速度上升，因为它们质量相同，受力也相同。
            </p>
            <p>
            【40】两个空心球，大小及重量相同，但材料不同。一个是金，一个是铅。空心球表面图有相同颜色的油漆。现在要求在不破坏表面油漆的条件下用简易方法指出哪个是金的，哪个是铅的。
            <br/><strong>Answer : </strong>旋转看速度，金的密度大，质量相同，所以金球的实际体积较小，因为外半径相同，所以金球的内半径较大，所以金球的转动惯量大，在相同的外加力矩之下，金球的角加速度较小，所以转得慢。
            </p>
            <p>
            【41】有23枚硬币在桌上，10枚正面朝上。假设别人蒙住你的眼睛，而你的手又摸不出硬币的反正面。让你用最好的方法把这些硬币分成两堆，每堆正面朝上的硬币个数相同。
            <br/><strong>Answer : </strong>分成10＋13两堆， 然后翻转10的那堆
            </p>
            <p>
            ...
            <br/><strong>Answer : </strong> 答案如右图：
            </p>
            <p>
            【43】屋里三盏灯泡,屋外三个开关,一个开关仅控制一盏灯,屋外看不到屋里怎样只进屋一次,就知道哪个开关控制哪盏灯?四盏呢~
            <br/><strong>Answer : </strong>温度，先开一盏，足够长时间后关了，开另一盏，进屋看，亮的为后来开的，摸起来热的为先开的，剩下的一盏也就确定了。
            ...
            <br/><strong>Answer : </strong>1, 改变赋值号.比如+,-,=
            2, 注意质数.
            3, 可能把画面颠倒过来.
            4, 然后就可以去考虑更改其他数字更改了
            247-217＝30
            ...
            <br/><strong>Answer : </strong>如果轮到第四个海盗分配：100，0
            轮到第三个：99，0，1
            轮到第二个：98，0，1，0
            ...
            <p>
            【46】他们中谁的存活机率最大？
            <br/><strong>Answer : </strong>5个囚犯，分别按1-5号在装有100颗绿豆的麻袋抓绿豆，规定每人至少抓一颗，而抓得最多和最少的人将被处死，而且，他们之间不能交流，但在抓的时候，可以摸出剩下的豆子数。问他们中谁的存活几率最大？提示：　　　　　　
            1，他们都是很聪明的人　　　　　　
            2，他们的原则是先求保命，再去多杀人　　　　　　
            3，100颗不必都分完　　　　　　
            ...
            <br/><strong>Answer : </strong>这堆桃子至少有3121只。
            ...
            <br/><strong>Answer : </strong>晚上某个家伙悄悄的起床,悄悄的将椰子分成5份,结果发现多一个椰子,顺手就给了幸运的猴子,然后又悄悄的藏了一份,然后把剩下的椰子混在一起放回原处,最后还是悄悄滴回去睡觉了.
            ...
            <br/><strong>Answer : </strong>3月4日 3月5日 3月8日
            6月4日 6月7日
            9月1日 9月5日
            12月1日 12月2日 12月8日
            ...
            <br/><strong>Answer : </strong>问：如果我问另一个人死亡之门在哪里，他会怎么回答？
            最终得到的回答肯定是指向自由之门的。
            </p>
            <p>
            ...
            <br/><strong>Answer : </strong>老婆的儿子
            </p>
            <p>
            【52】“有一牧场，已知养牛27头，6天把草吃尽；养牛23头，9天把草吃尽。如果养牛21头，那么几天能把牧场上的草吃尽呢？并且牧场上的草是不断生长的。”
            <br/><strong>Answer : </strong>设牛每天吃掉x，草每天长出y，原来有牧场的草量是a
            a=(27x-y)*6=(23x-y)*9
            可解出y=15x,a=72x,所以a=(21x-y)*12,所以需要12天。
            </p>
            <p>
            【53】一个商人骑一头驴要穿越1000公里长的沙漠，去卖3000根胡萝卜。已知驴一次性可驮1000根胡萝卜，但每走一公里又要吃掉一根胡萝卜。问：商人共可卖出多少胡萝卜？
            <br/><strong>Answer : </strong>商人带驴驮1000根胡萝卜，先走200公里，来回走五轮吃掉1000根，再带驴驮1000根胡萝卜，走333.333公里，来回走三轮吃掉1000根，最后带着剩下的1000根走完剩下的466.666公里，剩下533.333根。
            </p>
            <p>
            【54】10箱黄金，每箱100块，每块一两。有贪官，把某一箱的每块都磨去一钱。请称一次找到不足量的那个箱子
            <br/><strong>Answer : </strong>第一箱子拿1块，第二箱子拿2块， 第n箱子拿n块，然后放在一起称，看看缺了几钱，缺了n钱就说明是第n个箱子
            </p>
            <p>
            【55】你让工人为你工作７天，给工人的回报是一根金条。金条平分成相连的７段，你必须在每天结束时都付费，如果只许你两次把金条弄断，你如何给你的工人付费？
            <br/><strong>Answer : </strong>把金条分成1，2，4三段。第一天1，第二天2，第三天1+2……第七天1+2+4。
            </p>
            <p>
            【56】有十瓶药，每瓶里都装有100片药（仿佛现在装一百片的少了，都是十片二十片的，不管，咱们就这么来了），其中有八瓶里的药每片重10克，另有两瓶里的药每片重9克。用一个蛮精确的小秤，只称一次，如何找出份量较轻的那两个药瓶？
            <br/><strong>Answer : </strong>等同54，但此题有一些变化，与众不同的瓶子有两个，只称一次的话，只能得到两个瓶子所缺的克数的总和，我们必须保证能从总和中唯一地得出两个瓶子的所缺数。第一个瓶可拿出1片，第二个拿2片，第三个拿3片，但第四个不能拿4片，因为如果结果缺了5克的话，你就不知道是缺了2+3还是1+4。所以第四个应拿5片，第五个应拿8片，第n个应拿a(n-1)+a(n-2)片。
            </p>
            <p>
            ...
            <br/><strong>Answer : </strong>设总距离为d，总共用时d/(15+20)，两车相遇，所以鸟飞了30*d/(15+20)=6d/7
            </p>
            <p>
            ...
            <br/><strong>Answer : </strong>3 。如果只有1人戴黑帽子，那么第一次关灯他就会打自己耳光；如果有2人，第二次关灯他们就会打自己耳光；有n人戴帽子的话第n次关灯他们就会打自己耳光。
            </p>
            <p>
            【66】两个圆环，半径分别是1和2，小圆在大圆内部绕大圆圆周一周，问小圆自身转了几周？如果在大圆的外部，小圆自身转几周呢？
            <br/><strong>Answer : </strong>把大圆剪断拉直。小圆绕大圆圆周一周，就变成从直线的一头滚至另一头。因为直线长就是大圆的周长，是小圆周长的2倍，所以小圆要滚动2圈。
            ...
            <br/><strong>Answer : </strong>40瓶，20+10+5+2+1+1=39， 这时还有一个空瓶子，先向店主借一个空瓶，换来一瓶汽水喝完后把空瓶还给店主。
            </p>
            <p>
            ...
            <br/><strong>Answer : </strong>“有3顶黑帽子，2顶白帽子。让三个人从前到后站成一排，给他们每个人头上戴一顶帽子。每个人都看不见自己戴的帽子的颜色，却只能看见站在前面那些人的帽子颜色。（所以最后一个人可以看见前面两个人头上帽子的颜色，中间那个人看得见前面那个人的帽子颜色但看不见在他后面那个人的帽子颜色，而最前面那个人谁的帽子都看不见。现在从最后那个人开始，问他是不是知道自己戴的帽子颜色，如果他回答说不知道，就继续问他前面那个人。事实上他们三个戴的都是黑帽子，那么最前面那个人一定会知道自己戴的是黑帽子。为什么？”
            ...
            <br/><strong>Answer : </strong>首先拿4个 别人拿n个你就拿6－n个
            </p>
            <p>
            ...
            <br/><strong>Answer : </strong>现在要讲一讲本题的奇妙之处。对饲养山羊颇有研究，还写过书的乔治．阿伯克龙比说道：“通过反复实验，我发现，动量相当于一个自20英尺高处坠落下来 的30磅重物的一次撞击，正好可以打碎山羊的脑壳，致它死命。”如果他说得不错，那么这两只山羊至少要有多大的逼近速度，才能相互撞破脑壳？你能算出来 吗？
            1英尺（ft）=0.3048米（m）
            1磅（lb）=0.454千克（kg）
            ...
            <br/><strong>Answer : </strong>11,0-->4,7-->4,0-->0,4-->11,4-->8,7-->8,0-->1,7-->1,0-->0,1-->11,1-->5,7-->5,0-->0,5-->11,5-->9,7-->9,0-->2,7，这样就有2斤了。
            </p>
            <p>
            ...
            <br/><strong>Answer : </strong>需要3架飞机（记为A，B，C），A走完全程。如下图，黑色箭头表示飞行方向，红色箭头表示一架给另一架加油，红色数字表示加油量整个油箱容量的比值。
            </p>
            <p>
            ...
            <br/><strong>Answer : </strong>问：请问你从哪里来？
            回答肯定都是指向诚实国的。
            </p>
            <p>
            【75】在一天的24小时之中，时钟的时针、分针和秒针完全重合在一起的时候有几次？都分别是什么时间？你怎样算出来的？
            <br/><strong>Answer : </strong>只有两次
