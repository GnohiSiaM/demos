...
<html>
    ...
    <body style="background:#ECECEC url(image/bg.png)">
        <div id="banner">
            <canvas id="process">环形进度条</canvas>
            <ul id="switch_image">
                <li><a href="#"><img src="image/banner1.jpg" alt="" /></a><span>如果你喜欢,那就继续往下点击.</span></li>
                <li><a href="#"><img src="image/banner2.jpg" alt="" /></a><span>GnohiSiaM</span></li>
                <li><a href="#"><img src="image/banner3.jpg" alt="" /></a><span>HelloMonday</span></li>
                <li><a href="#"><img src="image/banner4.jpg" alt="" /></a><span>Banana</span></li>
                <li><a href="#"><img src="image/banner5.jpg" alt="" /></a><span>Apple</span></li>
                <li><a href="#"><img src="image/banner6.jpg" alt="" /></a><span>Mango</span></li>
            </ul>
