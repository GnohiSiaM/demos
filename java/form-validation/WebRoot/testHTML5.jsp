...
<html>
    ...
    <body class="flexbox" style="background:#f0f0f0 url(image/bg.png); font-family:Microsoft Yahei;">
        <div class="divBox">
            <p class="myText">HTML5 - Form Validation</p>
            <form action="RegisterServlet" method="post">
                <div class="line">
                    <label for="username" class="labelText">账 号</label>
                    <input class="inputText" type="text" id="username" name="username" required pattern="^\S+$"/><br>
                </div>
