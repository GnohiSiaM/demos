...
<html>
    <head>
        ...
        <style>
            @font-face {
                ...
                src: url('font/beyond_wonderland-webfont.eot');
                src: url('font/beyond_wonderland-webfont.eot?#iefix') format('embedded-opentype'),
                     url('font/beyond_wonderland-webfont.woff') format('woff'),
                     url('font/beyond_wonderland-webfont.ttf') format('truetype'),
                     url('font/beyond_wonderland-webfont.svg#beyond_wonderlandregular') format('svg');
                font-weight: normal;
                font-style: normal;
            }
            .agreement {
    ...
    <body style="background:#f0f0f0 url(image/bg.png); font-family:Microsoft Yahei;">
        <div class="box">
            ...
            <p>
                GnohiSiaM目前向用户提供如下服务：发布并分享对图书、电影、音乐的评论；收藏图书、电影、音乐；在GnohiSiaM中发布话题、日记、上传图片；在同城中发布或参加各类活动。除非本使用协议另有其它明示规定，增加或强化目前本服务的任何新功能，包括所推出的新产品，均受到本使用协议之规范。您了解并同意，本服务仅依其当前所呈现的状况提供，对于任何用户信息或个人化设定之时效、删除、传递错误、未予储存或其它任何问题，GnohiSiaM均不承担任何责任。GnohiSiaM保留不经事先通知为维修保养、升级或其它目的暂停本服务任何部分的权利。
            </p>
            <p>
