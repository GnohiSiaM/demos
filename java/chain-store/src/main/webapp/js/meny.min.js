    ...
    function(a){
        return(
            function(){
                ...
                var D={width:300,height:300,position:N,threshold:40,overlap:6,transitionDuration:"0.5s",transitionEasing:"ease"};
                var e={menu:a.menuElement,contents:a.contentsElement,wrapper:a.menuElement.parentNode,cover:null};
                ...
                function i(){
                    ...
                    switch(D.position){
                        ...
                        case c: l="50% 100%";
                                ...
                                V="50% 100%";
                                x="translateY( -"+D.height+"px ) rotateX( 15deg )";
                                n={bottom:"-"+(D.height-D.overlap)+"px"};
                                O={bottom:"0px"};
                                d={top:"0px"};
                                B={top:"-"+D.height+"px"};
                                break;
                ...
                function v(){
                    ...
                    if(F){e.cover.style[Meny.prefix("transition")]="all "+D.transitionDuration+" "+D.transitionEasing;}
                ...
                function u(){
                    if(!f){
                        ...
                        if(F){
                            ...
                            E&&E.stop();
                            E=Meny.animate(e.cover,{opacity:1},500);
                        }
                ...
                function I(){
                    if(f){
                        ...
                        if(F){
                            ...
                            E&&E.stop();
                            E=Meny.animate(e.cover,{opacity:0},500,function(){e.cover.style.visibility="hidden";});
                        }
                    ...
                    if(!m){
                        ...
                        switch(D.position){
                            case J: if(aa>D.height){
                                    ...
                                    break;
                            case K: var X=e.wrapper.offsetWidth;
                                     if(W<X-D.width){
                                        I();
                                    }else{
                                        if(W>X-D.threshold){
                                    ...
                                    break;
                            case c: var Y=e.wrapper.offsetHeight;
                                    if(aa<Y-D.height){
                                        I();
                                    }else{
                                        if(aa>Y-D.threshold){
                ...
                return{open:u,close:I,isOpen:function(){return f;},addEventListener:function(W,X){e.menu&&Meny.bindEvent(e.menu,W,X);},removeEventListener:function(W,X){e.menu&&Meny.unbindEvent(e.menu,W,X);}};
            }
        )();
    },
animate:
    function(b,a,c,d){
        return(
            function(){
                var g={};
                for(var j in a){
                    g[j]={start:parseFloat(b.style[j])||0,end:parseFloat(a[j]),unit:(typeof a[j]==="string"&&a[j].match(/px|em|%/gi))?a[j].match(/px|em|%/gi)[0]:""};
                }
                var i=Date.now(),e;
                function h(){
...
prefix:
    function(e,d){
        ...
        for(var c=0,a=g.length;c<a;c+=1){
            var f=g[c];
...
getQuery:
    function(){
        var a={};
        location.search.replace(/[A-Z0-9]+?=([\w|:|\/\.]*)/gi,function(b){a[b.split("=").shift()]=b.split("=").pop();});
        return a;
    }
};
