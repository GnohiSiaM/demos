...
namespace CHSS.DAL
{
    ...
    public partial class CFunction
    {
        ...
        public int GetMaxId()
        {
        return DBHelper.GetMaxID("FID", "CFunction");
        }
        ...
        public bool Exists(int FID)
        {
            ...
            strSql.Append("select count(1) from CFunction");
        ...
        public bool Delete(int FID)
        {
            ...
            StringBuilder strSql=new StringBuilder();
            strSql.Append("delete from CFunction ");
            strSql.Append(" where FID=@FID");
            SqlParameter[] parameters = {
                    new SqlParameter("@FID", SqlDbType.Int,4)
            };
        ...
        {
            StringBuilder strSql=new StringBuilder();
            strSql.Append("select FID,FuncName,FuncAbbr,MID ");
            strSql.Append(" FROM CFunction ");
            if(strWhere.Trim()!="")
            {
        ...
        public DataSet GetList(int Top,string strWhere,string filedOrder)
        {
            ...
            strSql.Append(" FID,FuncName,FuncAbbr,MID ");
            strSql.Append(" FROM CFunction ");
            if(strWhere.Trim()!="")
            {
                strSql.Append(" where "+strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from CFunction T ");
