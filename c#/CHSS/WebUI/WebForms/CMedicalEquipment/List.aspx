<%@ Page Title="医疗设备列表" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="CHSS.Web.CMedicalEquipment.List" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="gridView" style="border: 0 #eee;" runat="server" AllowPaging="True" Width="100%" CellPadding="3" OnPageIndexChanging="gridView_PageIndexChanging" BorderWidth="1px"
        DataKeyNames="MID" OnRowDataBound="gridView_RowDataBound" AutoGenerateColumns="false" PageSize="10" RowStyle-HorizontalAlign="Center" OnRowCreated="gridView_OnRowCreated">
        <Columns>
            ...
            <asp:BoundField DataField="MediName" HeaderText="设备名称" SortExpression="MediName" ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="MediDescription" HeaderText="设备描述" SortExpression="MediDescription" ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="RealName" HeaderText="最后编辑人" SortExpression="RealName" ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="MediAddDate" HeaderText="添加日期" SortExpression="MediAddDate" ItemStyle-HorizontalAlign="Center" />
            <%--<asp:BoundField DataField="UID" HeaderText="UID" SortExpression="UID" ItemStyle-HorizontalAlign="Center" />--%>
            <asp:HyperLinkField HeaderText="详细" ControlStyle-Width="50" DataNavigateUrlFields="MID" DataNavigateUrlFormatString="Show.aspx?id={0}" Text="详细" />
            <asp:HyperLinkField HeaderText="编辑" ControlStyle-Width="50" DataNavigateUrlFields="MID" DataNavigateUrlFormatString="Modify.aspx?id={0}" Text="编辑" />
