<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="CHSS.Web.CAmbulance.Modify" Title="修改救护车信息" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#MainContent_txtAmbuAddDate').datepicker({
                format: "yyyy年m月d日",
                todayBtn: "linked",
                language: "zh-CN",
                calendarWeeks: true,
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="width: 520px; margin: 0 auto;">
        ...
        <div class="line">
            ...
            <asp:TextBox class="inputText" ID="txtAmbuNumber" runat="server"></asp:TextBox>
        </div>
        <div class="line">
            <label for="MainContent_txtAmbuAddDate" class="labelText">添加日期</label>
            <asp:TextBox class="inputText" ID="txtAmbuAddDate" runat="server"></asp:TextBox>
        </div>
        <div class="line">
            <label for="MainContent_txtAmbuDescription" class="labelText">救护车描述</label>
            <asp:TextBox TextMode="MultiLine" Height="80px" class="inputText" ID="txtAmbuDescription" runat="server"></asp:TextBox>
        </div>
    </div>
