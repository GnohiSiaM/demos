<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="CHSS.Web.CExpert.Modify" Title="修改页" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server"> 
    ...
    <div style="width: 520px; margin: 0 auto;">
        <div class="line">
            ...
            <asp:TextBox class="inputText" ID="txtEID" ReadOnly="true" runat="server"></asp:TextBox>
        </div>
        <div class="line">
        ...
        <div class="line">
            ...
            <asp:TextBox class="inputText" ID="txtExpePicURL" runat="server"></asp:TextBox>
        </div>
        <div class="line">
