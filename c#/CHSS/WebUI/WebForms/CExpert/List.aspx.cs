    ...
    public partial class List : Page
    {
        ...
        public void BindData()
        {
            ...
            if (txtKeyword.Text.Trim() != "")
            {
                ...
                strWhere.AppendFormat("ExpeName like '%{0}%' or ExpePhone like '%{0}%' or ExpeAddDate like '%{0}%' or ExpeDescription like '%{0}%' or RealName like '%{0}%'", txtKeyword.Text.Trim());
            }
