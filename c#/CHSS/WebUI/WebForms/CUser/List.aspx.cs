    ...
    public partial class List : Page
    {
        ...
        public void BindData()
        {
            ...
            if (txtKeyword.Text.Trim() != "")
            {
                ...
                strWhere.AppendFormat("RealName like '%{0}%' or UserName like '%{0}%' or Gender like '%{0}%' or BornDate like '%{0}%' or Phone like '%{0}%' or Address like '%{0}%' or IDNumber like '%{0}%' or RoleName like '%{0}%'", txtKeyword.Text.Trim());
            }
